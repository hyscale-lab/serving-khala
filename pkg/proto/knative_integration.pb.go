...
// 	protoc        v3.19.4
// source: knative_integration.proto
...
func (x *AddVMRequest) Reset() {
	*x = AddVMRequest{}
	mi := &file_knative_integration_proto_msgTypes[0]
...
func (*AddVMRequest) Descriptor() ([]byte, []int) {
	return file_knative_integration_proto_rawDescGZIP(), []int{0}
}
...
type AddVMResponse struct {
	...
	TraceInfo     []string               `protobuf:"bytes,6,rep,name=trace_info,json=traceInfo,proto3" json:"trace_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AddVMResponse) Reset() {
	*x = AddVMResponse{}
	mi := &file_knative_integration_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddVMResponse) Descriptor() ([]byte, []int) {
	return file_knative_integration_proto_rawDescGZIP(), []int{1}
}
...
func (x *AddVMResponse) GetTraceInfo() []string {
	if x != nil {
		return x.TraceInfo
	}
	return nil
...
var File_knative_integration_proto protoreflect.FileDescriptor

const file_knative_integration_proto_rawDesc = "" +
	"\n" +
	"\x19knative_integration.proto\x12\x05proto\"'\n" +
	"\fAddVMRequest\x12\x17\n" +
	"\avm_name\x18\x01 \x01(\tR\x06vmName\"\xad\x01\n" +
	...
	"\x0eCreateSnapshot\x12\x1c.proto.CreateSnapshotRequest\x1a\x1d.proto.CreateSnapshotResponseB\x1fZ\x1dknative.dev/serving/pkg/protob\x06proto3"

var (
	file_knative_integration_proto_rawDescOnce sync.Once
	file_knative_integration_proto_rawDescData []byte
)

func file_knative_integration_proto_rawDescGZIP() []byte {
	file_knative_integration_proto_rawDescOnce.Do(func() {
		file_knative_integration_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_knative_integration_proto_rawDesc), len(file_knative_integration_proto_rawDesc)))
	})
...
func init() { file_knative_integration_proto_init() }
func file_knative_integration_proto_init() {
	if File_knative_integration_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_knative_integration_proto_goTypes,
		DependencyIndexes: file_knative_integration_proto_depIdxs,
		MessageInfos:      file_knative_integration_proto_msgTypes,
	}.Build()
	File_knative_integration_proto = out.File
	file_knative_integration_proto_goTypes = nil
	file_knative_integration_proto_depIdxs = nil
}
